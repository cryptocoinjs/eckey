...
if (typeof define !== 'undefined' && define.amd) { //require.js / AMD
  var mods = ['bigint', 'ecc', 'ecc-named', 'base58', 'sha256', 'ripemd160', 'convert-hex', 'address-btc']
  mods = mods.map(function(m) { return 'cryptocoin-' + m})
  define(mods, function(bigint, ecc, getSECCurveByName, _base58, _sha256, _ripe160, _convertHex, Address) {
    BigInteger = bigint
