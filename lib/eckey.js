...
if (typeof define !== 'undefined' && define.amd) { //require.js / AMD
  var mods = ['bigint', 'ecc', 'ecc-named', 'base58', 'sha256', 'ripemd160'].map(function(m) { return 'cryptocoin-' + m})
  define(mods, function(bigint, ecc, getSECCurveByName, _base58, _sha256, _ripe160) {
    BigInteger = bigint
